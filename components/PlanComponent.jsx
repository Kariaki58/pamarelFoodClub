      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            {planType === 'basic' ? 'Ready to Begin Your Journey?' :
             planType === 'classic' ? 'Ready for Royal-Level Rewards?' : 'Ready for Elite Rewards?'}
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            {planType === 'basic' ? 'Join thousands of entrepreneurs building wealth with Pamarel\'s proven system' :
             planType === 'classic' ? `Join the Classic Food Plan and earn up to ₦45,000,000 in rewards` :
             'Join the Deluxe Food Plan and earn up to ₦300,000,000 in rewards'}
          </p>
          <motion.div
          ...
          >
            <Button 
              onClick={handleRegister}
              disabled={isProcessing}
              className={`inline-flex text-gray-900 items-center justify-center px-8 py-6 border border-transparent text-base font-medium rounded-md  bg-${plan.color}-600 hover:bg-${plan.color}-700 md:py-6 md:text-lg md:px-10 transition-all duration-200 hover:shadow-lg ${
