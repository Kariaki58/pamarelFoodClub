      ...
      <div className="container mx-auto px-4 py-12 md:px-6">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="#" className="hover:underline">How to shop on pamarel?</Link></li>
              ...
              <li><Link href="#" className="hover:underline">Report a Product</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="#" className="hover:underline">Become a club member</Link></li>
            </ul>
          </div>

        </div>

        <div className="mt-12 border-t border-gray-700 pt-8 flex flex-col md:flex-row items-center gap-8">
            {/* Newsletter section */}
        ...
        <div className="mt-12 border-t border-gray-700 pt-8 flex flex-col sm:flex-row justify-between items-center text-center sm:text-left gap-4">
            ...
            <div className="flex items-center space-x-4 order-1 sm:order-2">
                ...
                <span className="text-sm font-mono">VISA</span>
                <span className="text-sm font-mono">MasterCard</span>
                <span className="text-sm font-mono">Verve</span>
            </div>
        </div>
      </div>
    </footer>
