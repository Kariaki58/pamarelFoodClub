    ...
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-white">
      ...
      <header className="bg-yellow-500 text-white py-6">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center">Contact Pamarel</h1>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">4 Uroye Street, Ubeji,<br />Warri, Delta state</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">pamarelfoods@gmail.com</p>
                </div>
              </div>
            ...
            <div className="pt-4">
              ...
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/profile.php?id=61573028302471&mibextid=ZbWKwL" target='_blank' className="bg-yellow-500 hover:bg-yellow-600 text-white p-3 rounded-full transition duration-300">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                  </svg>
                </a>

                <a href="https://www.instagram.com/pamarelfoodmarket?utm_source=qr&igsh=NWtkOWMxYzFra2Zh" target='_blank' className="bg-yellow-500 hover:bg-yellow-600 text-white p-3 rounded-full transition duration-300">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
