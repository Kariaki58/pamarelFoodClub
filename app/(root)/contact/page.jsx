  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await emailjs.send(
        ...
        process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID2, // using ID2
        templateParams,
            ...
            <div className="pt-4">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  target="_blank"
                  className="bg-yellow-500 hover:bg-yellow-600 text-white p-3 rounded-full transition duration-300"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
