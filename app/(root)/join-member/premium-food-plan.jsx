      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center">
          ...
          >
            <Link 
              href="/visual" 
              className="my-3 inline-flex justify-center px-12 py-4 border border-transparent text-lg font-bold rounded-full shadow-lg text-white bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-900 transition-all duration-200 hover:shadow-xl"
            >
